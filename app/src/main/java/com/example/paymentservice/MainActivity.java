        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sb.append("Money=" + money).append('\n')
                        .append("Payment Information=" + info).append('\n')
                        .append("Is checkbox checked: " + mBankCardChkBx.isChecked()).append('\n')
                        .append("Is checkbox checked: " + mMobilePhoneChkBx.isChecked()).append('\n')
                        .append("Is checkbox checked: ").append(mCashAddressChkBx.isChecked()).append('\n');
